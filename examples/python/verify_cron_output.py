...
try:
    ...
    data_not_empty = bool(data.get('data'))
...
requests.post(f"https://deadmanping.com/api/ping/{MONITOR_ID}?is_valid_json={is_valid_json}&has_required_fields={has_required_fields}&data_not_empty={data_not_empty}")

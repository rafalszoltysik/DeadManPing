    ...
    <div>
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6 sm:mb-8">
        ...
        <Link
          ...
          className="bg-primary text-primary-foreground hover:bg-primary/90 px-4 py-2 rounded-lg text-sm font-medium transition-smooth hover-lift flex items-center justify-center gap-2 w-full sm:w-auto"
        >
      ...
      {sortedMonitors.length === 0 ? (
        <div className="bg-card border border-border rounded-lg sm:rounded-xl shadow-sm p-8 sm:p-12 text-center">
          ...
          <Link
            ...
            className="inline-block bg-primary text-primary-foreground hover:bg-primary/90 px-6 py-3 rounded-lg font-medium transition-smooth hover-lift text-sm sm:text-base"
          >

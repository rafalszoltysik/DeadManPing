 ...
 * 
 * Auto-generated types from Supabase database schema. Defines types for all tables,
 * columns, relationships, and JSON types. Used for type-safe database queries
 * throughout the application. Regenerated by generate-types script after schema changes.
 * 
 * Does not contain business logic - only type definitions matching database schema.
 */
...
/**
 * Main database type definition with all tables and their relationships.
 * 
 * Used as generic parameter for Supabase client: createClient<Database>(url, key).

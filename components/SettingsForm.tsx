...
import { WarningIcon, InfoIcon, EyeIcon, EyeOffIcon } from './Icons'
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-3 py-2 pr-10 border border-input rounded-lg bg-background focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent transition-smooth"
                />
                <button
                  type="button"
